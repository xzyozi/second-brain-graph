...
def code_node(state: GraphState) -> GraphState:
    ...
    AiderRunError 発生時は LLM_TIMEOUT としてカウンタを加算し、1回目は再試行、2回目は FAILED_SYSTEM とする。
    """
...
def main() -> None:
    ...
    parser.add_argument("--issue-id", required=True, help="対象のIssue ID (例: EC-0001)")
